...
def run_sample_pipeline():
    ...
    print(f"Extracted {len(extracted_data)} records from database")
    ...
    producer.flush()
    print(f"Sent {len(cleaned_df)} records to Kafka topic 'ecommerce-stream'")
    
    # 5. Process the stream
    print("Starting stream processing (will run for 30 seconds)...")
